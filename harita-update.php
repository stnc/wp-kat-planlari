...
$stncForm_tableNameMain = $wpdb->prefix . 'stnc_floor_building';
    ...
    date_default_timezone_set('Europe/Istanbul');
      ...
      global $stncForm_tableNameMain;
      $thepost = $wpdb->get_row($wpdb->prepare("SELECT *  FROM ".$stncForm_tableNameMain."  WHERE id = %d", 1));
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="square_meters" value="<?php echo $square_meters ?>" class="form-control"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="company_description" id="company_description"
                                        rows="3"><?php echo $company_name ?></textarea>
                                </div>

                                <hr>
                                <div class="form-group">
                                    <label for="address">adress</label>
                                    <input type="text" name="address" value="<?php echo $company_name ?>" class="form-control" id="address">
                                </div>
                                <hr>
                                <div class="form-group">
                                    <label for="media_id">Resim </label>
                                    <input type="text" name="media_id" value="<?php echo $company_name ?>" class="form-control" id="media_id">
                                </div>
                                <hr>
                                <br>
