...
function stnc_wp_floor_MainMenu(){
 ...
 add_menu_page('Erciyes Teknopark Başvuruları','Teknopark Binalar', 'manage_options', 'map_homepage_stnc', 'stnc_wp_floor_adminMenu_map_homepage_stnc','dashicons-networking'); ////burası main menuyu ekler yani üst ksıım 
