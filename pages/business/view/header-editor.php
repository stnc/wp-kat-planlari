        ...
        <div class="container-fluid">
            ...
            <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link"
                            href="/wp-admin/admin.php?page=map_view_stnc&st_trigger=show&binaid=<?php echo $_GET['binaid']?>&kat=<?php echo $_GET['kat']?>">Yerleşimi göster</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link"
                            href="http://summit.test/wp-admin/admin.php?page=building_map_editor_stnc&st_trigger=show&id=<?php echo $_GET['binaid']?>&kat=<?php echo $_GET['kat']?>">Harita Değiştir</a>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdown01">
                         ...
                         foreach ($buildingsList as $building) : ?>
                            <li><a class="dropdown-item" href="/wp-admin/admin.php?page=map_view_stnc&st_trigger=map_editor&binaid=<?php echo $_GET['binaid']?>&kat=<?php echo $building->id ?>"><?php echo $building->name ?></a></li>
                        <?php endforeach ?>
                        </ul>
                    </li>
                    <li class="nav-item">
